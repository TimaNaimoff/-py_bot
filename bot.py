...
def start(message):
    welcome_text = (
        ...
        "**Типы уровней:**\n"
        "🐣 **Легкие**: дается английское слово, нужно перевести на русский эквивалент.\n"
        "👼 **Средние**: дается русское слово, нужно перевести на английский эквивалент.\n"
        "🎩 **Продвинутые**: дается английская аудиозапись с 1 словом, нужно перевести её на русский.\n"
        "😈 **Сложные**: дается английское лексическое описание, нужно корректно подобрать под него слово.\n"
        "🛸 **Инопланетные**: дается английское лексическое описание в виде аудиозаписи, нужно корректно подобрать под него слово.\n"
    )
